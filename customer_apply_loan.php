...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="customer_apply_loan.php" class="active"><div class="link-icon" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);"><i class="fas fa-file-signature"></i></div> Apply for Loan</a>
    ...
    <div class="main-content page-content" id="mainContent">
        <h4 class="mb-4">
            <span style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; background: linear-gradient(135deg, #10b981 0%, #059669 100%); border-radius: 10px; margin-right: 10px; box-shadow: 0 4px 15px rgba(16, 185, 129, 0.3);">
