...
<body>
    <div class="login-container">
        ...
        <div class="login-box">
            ...
            <h2><span class="header-badge">User Registration</span></h2>
...
body.dark-mode .form-group input::placeholder { color: #94a3b8 !important; }
body.dark-mode .login-box { background: #1e293b; }
body.dark-mode .login-box h2 { color: #e2e8f0; }
...
body.dark-mode .password-requirements small { color: #e2e8f0; }
body.dark-mode .password-rules li { color: #e2e8f0; }
body.dark-mode .password-requirements li.valid { color: #10b981; }
body.dark-mode .password-requirements li.invalid { color: #f87171; }
body.dark-mode .login-container { background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); }
