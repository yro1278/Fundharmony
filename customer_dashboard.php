...
<div class="session-timer" id="sessionTimer">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            <a href="customer_dashboard.php" class="active">
                <div class="link-icon" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);"><i class="fas fa-grip-horizontal"></i></div> Dashboard
            </a>
            <?php if($is_account_active): ?>
            <?php if(!$has_active_loan): ?>
            <a href="customer_apply_loan.php">
                <div class="link-icon" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);"><i class="fas fa-file-signature"></i></div> Apply for Loan
            </a>
            <?php else: ?>
            <a href="#" style="opacity:0.5;cursor:not-allowed;" title="You have an existing loan application">
                <div class="link-icon" style="background: linear-gradient(135deg, #10b981 0%, #059669 100%);"><i class="fas fa-file-signature"></i></div> Apply for Loan <i class="fas fa-lock fa-xs"></i>
            </a>
            <?php endif; ?>
            <a href="customer_my_loans.php">
                <div class="link-icon" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%);"><i class="fas fa-coins"></i></div> My Loans
            </a>
            <a href="customer_make_payment.php">
                <div class="link-icon" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);"><i class="fas fa-money-bill-wave"></i></div> Make Payment
            </a>
            <?php else: ?>
            ...
            <a href="#" style="opacity:0.5;cursor:not-allowed;" title="Account deactivated">
                <div class="link-icon" style="background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%);"><i class="fas fa-coins"></i></div> My Loans <i class="fas fa-lock fa-xs"></i>
            </a>
            <a href="#" style="opacity:0.5;cursor:not-allowed;" title="Account deactivated">
                <div class="link-icon" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);"><i class="fas fa-money-bill-wave"></i></div> Make Payment <i class="fas fa-lock fa-xs"></i>
            </a>
            <?php endif; ?>
            <a href="customer_payment_history.php">
                <div class="link-icon" style="background: linear-gradient(135deg, #64748b 0%, #475569 100%);"><i class="fas fa-history"></i></div> Payment History
            </a>
        </div>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="page-header">
            <h2>
                ...
                Welcome back, <?php echo $_SESSION['customer_name']; ?>!
            </h2>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const cards = document.querySelectorAll('.stat-card, .card, .page-header');
