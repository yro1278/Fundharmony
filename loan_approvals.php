            ...
            <div class="col">
                <div class="card loan-card h-100" style="font-size: 0.85rem;">
                    ...
                    <div class="card-footer d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-danger btn-sm flex-fill" data-bs-toggle="modal" data-bs-target="#rejectModal<?php echo $loan['account_number']; ?>">
                            <i class="fas fa-times"></i> Reject
                        </button>
                    </div>
                    
                    <!-- Reject Modal -->
                    <div class="modal fade" id="rejectModal<?php echo $loan['account_number']; ?>" tabindex="-1" data-bs-backdrop="static">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="app/reject_loan.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="reject_notes" class="form-control" rows="3" placeholder="Enter reason for rejection..." style="pointer-events: auto; opacity: 1; position: relative; z-index: 1000;"></textarea>
                                        </div>
                                    </div>
