...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="customer_make_payment.php" class="active"><div class="link-icon" style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%);"><i class="fas fa-money-bill-wave"></i></div> Make Payment</a>
    ...
    <div class="main-content page-content" id="mainContent">
        <h4 class="mb-4">
            <span style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); border-radius: 10px; margin-right: 10px; box-shadow: 0 4px 15px rgba(245, 158, 11, 0.3);">
