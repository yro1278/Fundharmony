...
body.dark-mode .login-box h2 .logo-icon {
    background: linear-gradient(135deg, #818cf8 0%, #6366f1 100%);
}
body.dark-mode .login-box h2 .logo-icon i {
    color: white;
}
    ...
    <div class="login-container">
        <div class="login-box">
            <h2>
                ...
                <span class="title-text">Verify OTP</span>
            </h2>
