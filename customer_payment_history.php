...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="customer_payment_history.php" class="active"><div class="link-icon" style="background: linear-gradient(135deg, #64748b 0%, #475569 100%);"><i class="fas fa-history"></i></div> Payment History</a>
        </div>
    ...
    <div class="main-content page-content" id="mainContent">
        <h4 class="mb-4">
            <span style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; background: linear-gradient(135deg, #64748b 0%, #475569 100%); border-radius: 10px; margin-right: 10px; box-shadow: 0 4px 15px rgba(100, 116, 139, 0.3);">
